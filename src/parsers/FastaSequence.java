...
public class FastaSequence implements Comparable<FastaSequence>
{
	...
	public static HashMap<String, FastaSequence> getFirstTokenSequenceMap( String filePath ) throws Exception
	{
		return getFirstTokenSequenceMap( new File( filePath ) );
	}

	public static HashMap<String, FastaSequence> getFirstTokenSequenceMap( File file ) throws Exception
	{
	 ...
	 */
	public static List<FastaSequence> getOnlyMatching( File fileToParse, HashSet<String> matchingFirstTokens )
			throws Exception
	{
		...
		while( nextLine != null )
		{
			...
			{
				returnList.add( new FastaSequence( originalHeader, buff.toString() ) );
			}
		}
