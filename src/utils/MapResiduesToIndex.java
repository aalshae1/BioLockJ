...
public class MapResiduesToIndex
{
	...
	public static final char[] residues = new char[ ] { 'A', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'K', 'L', 'M', 'N', 'P',
			'Q', 'R', 'S', 'T', 'V', 'W', 'Y' };

	public static int NUM_VALID_RESIDUES = residues.length;

	public static final Character[] charResidues = new Character[ ] { new Character( 'A' ), new Character( 'C' ),
			new Character( 'D' ), new Character( 'E' ), new Character( 'F' ), new Character( 'G' ),
			new Character( 'H' ), new Character( 'I' ), new Character( 'K' ), new Character( 'L' ),
			new Character( 'M' ), new Character( 'N' ), new Character( 'P' ), new Character( 'Q' ),
			new Character( 'R' ), new Character( 'S' ), new Character( 'T' ), new Character( 'V' ),
			new Character( 'W' ), new Character( 'Y' ) };
