...
public class AddMBGDGeneAnnotationsToGTF extends BioLockJExecutor
{
	...
	private static HashMap<String, HashSet<Integer>> getFileLineMap( File extendedFile, HashSet<String> included )
			throws Exception
	{
	...
	public static void addGeneAnnotation( String inFile, String outFile, HashMap<Integer, String> lineDescriptions,
			HashMap<String, String> geneIdToProtMap, HashMap<String, HashSet<Integer>> fileLineMap ) throws Exception
	{
	...
	public void executeProjectFile() throws Exception
	{
		...
		HashMap<String, HashSet<Integer>> fileLineMap = getFileLineMap( mbdgFile, getNeededIds( topHitsFile ) );
		HashMap<Integer, String> map = getLineDescriptions( mbdgFile );

		addGeneAnnotation( inputFile.getAbsolutePath(), outFile.getAbsolutePath(), map, geneIdtoProtMap, fileLineMap );
	}
